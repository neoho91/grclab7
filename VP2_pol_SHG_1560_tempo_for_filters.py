...
def VP2_mapping_SHG(sample,ini_pos,map_size,resol=1,hero_int_time=2000,hero_avg_num=1,num_of_spec=5,alphas=[233,180],ana_offset=-50.99,pump_wl=1560,timesleep=0.5,pump_with_1560=True,pm_as_ref=False,log=''):
